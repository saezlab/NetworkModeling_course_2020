...
dissected with cell type-specific dynamic logic models. 
...
In the next step, we will associate model feratures to drug response to see why certain cell lines
...
In the turial we make a single model for he first cell line _COLO320HSR_. 
